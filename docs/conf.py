...
project = 'docs-Credo Documentation'
author = 'CREDOProject'
...
html_theme_options = {
    "source_repository": "https://github.com/CREDOProject/docs/",
...
html_baseurl = 'https://sphinx.silverrainz.me/Credo Documentation'
...
extlinks = {
    'issue': ('https://github.com/CREDOProject/docs/issues/%s', '💬%s'),
    'pull': ('https://github.com/CREDOProject/docs/pull/%s', '🚀%s'),
    'tag': ('https://github.com/CREDOProject/docs/releases/tag/%s', '🏷️%s'),
}
...
extensions.append('Credo Documentation')
